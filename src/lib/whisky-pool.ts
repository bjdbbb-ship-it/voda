...
export const whiskyPool: Partial<Whisky>[] = [
    ...
    // --- Islay (Peaty) ---
    {
        id: "p1", name: "Lagavulin 12 Year Old Special Release", type: "Single Malt", region: "Islay",
        ...
        tags: ["islay", "special release", "smoke"]
    },
    {
        id: "p2", name: "Ardbeg Corryvreckan", type: "Single Malt", region: "Islay",
        ...
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-02-26",
        tags: ["islay", "peat monster", "intense"]
    },
    {
        id: "p3", name: "Laphroaig Quarter Cask", type: "Single Malt", region: "Islay",
    ...
    {
        id: "p4", name: "Bowmore 15 Year Old", type: "Single Malt", region: "Islay",
        ...
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-02-26",
        tags: ["islay", "sherry", "balanced"]
    },
    {
        id: "p5", name: "Caol Ila Moch", type: "Single Malt", region: "Islay",
        ...
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-02-26",
        tags: ["islay", "elegant", "light smoke"]
    },

    // --- Speyside / Highland (Sherry/Sweet) ---
    {
        id: "p7", name: "GlenDronach 15 Year Old Revival", type: "Single Malt", region: "Highland",
        ...
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-02-26",
        tags: ["sherry monster", "rich", "speyside"]
    },
    {
        id: "p9", name: "Glenmorangie 18 Year Old", type: "Single Malt", region: "Highland",
        ...
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-02-26",
        tags: ["smooth", "floral", "highland"]
    },
    {
        id: "p10", name: "Dalmore King Alexander III", type: "Single Malt", region: "Highland",
        ...
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-02-26",
        tags: ["luxury", "multi-cask", "complex"]
    },

    // --- Japanese (Faceted/Elegant) ---
    {
        id: "p12", name: "Yamazaki 18 Year Old", type: "Single Malt", region: "Japan",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["japanese", "luxury", "balanced"]
    },
    {
        id: "p13", name: "Hakushu 18 Year Old", type: "Single Malt", region: "Japan",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["japanese", "forest", "fresh"]
    },

    // --- Bourbon (Square/Stout) ---
    {
        id: "p14", name: "Old Rip Van Winkle 10 Year", type: "Bourbon", region: "Kentucky",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["bourbon", "rare", "collectible"]
    },
    {
        id: "p15", name: "Pappy Van Winkle 23 Year", type: "Bourbon", region: "Kentucky",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["bourbon", "legendary", "ultra-premium"]
    },
    {
        id: "p17", name: "E.H. Taylor Small Batch", type: "Bourbon", region: "Kentucky",
        basePrice: 120, currency: "USD", priceRange: "premium",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["bourbon", "small batch", "traditional"]
    },

    // --- More Varieties ---
    {
        id: "p18", name: "Port Charlotte OLC:01", type: "Single Malt", region: "Islay",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["islay", "heavily peated", "sherry"]
    },
    {
        id: "p19", name: "Octomore 14.1", type: "Single Malt", region: "Islay",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["islay", "super heavily peated", "complex"]
    },
    {
        id: "p20", name: "Springbank 15 Year Old", type: "Single Malt", region: "Campbeltown",
        ...
        tags: ["campbeltown", "handmade", "sherry"]
    },
    {
        id: "p21", name: "Longrow Peated", type: "Single Malt", region: "Campbeltown",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["campbeltown", "peated", "intense"]
    },
    {
        id: "p22", name: "Kilkerran 12 Year Old", type: "Single Malt", region: "Campbeltown",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["campbeltown", "modern", "light smoke"]
    },
    {
        id: "p23", name: "Glenfarclas 25 Year Old", type: "Single Malt", region: "Speyside",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["speyside", "sherry", "venerable"]
    },
    {
        id: "p24", name: "Glengoyne 21 Year Old", type: "Single Malt", region: "Highland",
        basePrice: 220, currency: "USD", priceRange: "luxury",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["highland", "unpeated", "sherry"]
    },
    {
        id: "p25", name: "Macallan 18 Year Old Sherry Oak", type: "Single Malt", region: "Speyside",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["speyside", "iconic", "sherry"]
    },
    {
        id: "p26", name: "Talisker 18 Year Old", type: "Single Malt", region: "Islands",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["skye", "award winning", "complex"]
    },
    {
        id: "p27", name: "Highland Park 18 Year Old", type: "Single Malt", region: "Islands",
        basePrice: 160, currency: "USD", priceRange: "premium",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["orkney", "honey", "smoke"]
    },
    {
        id: "p28", name: "Glenmorangie Signet", type: "Single Malt", region: "Highland",
        basePrice: 250, currency: "USD", priceRange: "luxury",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["highland", "chocolate malt", "innovation"]
    },
    {
        id: "p29", name: "Oban Little Bay", type: "Single Malt", region: "Highland",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["highland", "coastal", "small cask"]
    },
    {
        id: "p30", name: "Royal Salute 21 Year Old Richard Quinn Edition", type: "Blended", region: "Scotland",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["luxury", "fashion", "smooth"]
    },
    {
        id: "p31", name: "Chivas Regal Ultis", type: "Blended Malt", region: "Scotland",
        basePrice: 220, currency: "USD", priceRange: "luxury",
        flavorProfile: { peat: 0, sweet: 8, fruit: 8, spice: 6, body: 8 },
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["blended malt", "premium", "rich"]
    },
    {
        id: "p33", name: "Compass Box The Peat Monster", type: "Blended Malt", region: "Scotland",
        basePrice: 65, currency: "USD", priceRange: "mid",
        ...
        tags: ["blended malt", "smoke", "monster"]
    },
    {
        id: "p34", name: "Nikka Yoichi 10 Year Old", type: "Single Malt", region: "Japan",
        basePrice: 150, currency: "USD", priceRange: "premium",
        ...
        availableDate: "2026-02-26",
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        tags: ["japanese", "coal-fired", "rich"]
    },
    {
        id: "p35", name: "Kavalan Solist Vinho Barrique", type: "Single Malt", region: "Taiwan",
        basePrice: 250, currency: "USD", priceRange: "luxury",
        ...
        tags: ["taiwan", "award winning", "wine cask"]
    },
    {
        id: "p36", name: "Amrut Intermediate Sherry", type: "Single Malt", region: "India",
        basePrice: 140, currency: "USD", priceRange: "premium",
        ...
        tags: ["india", "tropical aging", "sherry"]
    },
    // --- 2026 February New Releases ---
    {
        id: "n2602-1", name: "Hibiki Harmony (2026 Edition)", type: "Blended Whiskey", region: "Japan",
        ...
        tags: ["japanese", "suntory", "award-winner"],
    ...
    {
        id: "n2602-2", name: "Torabhaig 2018 Scottish Oak Single Cask", type: "Single Malt", region: "Isle of Skye, Scotland",
        ...
        tags: ["skye", "single cask", "scottish oak"],
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-02-27"
    },
    {
        id: "n2602-3", name: "Highland Park Heather Cask Strength", type: "Single Malt", region: "Islands, Scotland",
        basePrice: 110, currency: "USD", priceRange: "premium",
        ...
        tags: ["cask strength", "honey", "smoke"],
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-02-27"
    },
    {
        id: "n2602-4", name: "Lochlea 7 Year Old Single Estate", type: "Single Malt", region: "Lowland, Scotland",
        basePrice: 85, currency: "USD", priceRange: "mid",
        ...
        tags: ["single estate", "lowland", "fresh"],
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-02-27"
    },
    {
        id: "n2602-5", name: "Compass Box Hedonism 2026", type: "Blended Grain", region: "Scotland",
        basePrice: 150, currency: "USD", priceRange: "premium",
        ...
        tags: ["grain whiskey", "luxury", "smooth"],
        imageUrl: "https://images.unsplash.com/photo-1582260661131-4191c94d03e2?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-02-28"
    },
    {
        id: "n2602-6", name: "Ardbeg 10 Year Old Cask Strength (Committee 릴리즈)", type: "Single Malt", region: "Islay, Scotland",
        basePrice: 140, currency: "USD", priceRange: "premium",
        ...
        tags: ["committee release", "cask strength", "islay"],
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-02-28"
    },
    {
        id: "n2602-7", name: "Elijah Craig Barrel Proof Rye Batch A126", type: "Rye Whiskey", region: "Kentucky, USA",
        basePrice: 80, currency: "USD", priceRange: "mid",
        ...
        tags: ["barrel proof", "rye", "bold"],
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-02-28"
    },
    {
        id: "n2602-8", name: "13th Colony 113 Maple Bourbon", type: "Bourbon", region: "Georgia, USA",
        basePrice: 90, currency: "USD", priceRange: "mid",
        ...
        tags: ["maple finished", "bourbon", "sweet"],
        imageUrl: "https://images.unsplash.com/photo-1527281400683-1aabc8c4d5b5?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-03-01"
    },
    {
        id: "n2602-9", name: "Kavalan Triple Sherry Cask (Golden Steed)", type: "Single Malt", region: "Taiwan",
        basePrice: 180, currency: "USD", priceRange: "premium",
        ...
        tags: ["triple sherry", "taiwan", "rich"],
        imageUrl: "https://images.unsplash.com/photo-1516919549054-e08258825f8e?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-03-01"
    },
    {
        id: "n2602-10", name: "Godawan Triple Cask (Indian Single Malt)", type: "Single Malt", region: "India",
        basePrice: 120, currency: "USD", priceRange: "premium",
        ...
        tags: ["indian", "triple cask", "exotic"],
        imageUrl: "https://images.unsplash.com/photo-1585863264426-17b83ec50f38?auto=format&fit=crop&q=80&w=800",
        availableDate: "2026-03-01"
    },
];
