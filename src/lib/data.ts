...
,
    {
        id: "auto-1770009426955",
        slug: "microblend-1770009426955",
...
,
    {
        id: "auto-1770095210281",
        slug: "sherry cask-1770095210281",
        ...
        imageUrl: "",
        content: `위스키의 세계는 넓고 깊습니다. 수많은 선택지 앞에서 어떤 위스키를 선택해야 할지 고민이 되시나요? 오늘은 셰리 캐스크 애호가를 위한 필수 위스키 10선를 소개합니다.

## 추천 위스키

### 1. Miyagikyo Single Malt

**타입**: Single Malt Japanese | **지역**: Japan | **가격대**: 프리미엄 (10-20만원)

요이치와 대조되는 부드러움. 화사한 꽃향기와 셰리 오크의 달콤한 과일 맛.
...
### 3. Lustau Sherry Cask Redbreast

**타입**: Single Pot Still | **지역**: Ireland | **가격대**: 프리미엄 (10-20만원)

유명한 루스타우 셰리 하우스와의 협업으로 탄생한, 더욱 진하고 고소한 프리미엄 위스키.
...
달콤하고 풍부한 셰리 오크의 매력에 빠져보세요 위스키의 세계는 끝없이 넓고 깊습니다. 오늘 소개한 내용이 여러분의 위스키 여정에 작은 도움이 되기를 바랍니다. 
