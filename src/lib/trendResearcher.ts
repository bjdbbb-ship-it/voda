...
3. 도입부 - 원문의 모든 디테일이 살아있는 깊이 있는 상세 본문(최소 3개 이상의 섹션) - 전문가의 조언 - 마치며 섹션으로 구성하십시오.
...
1. **분량과 깊이 극대화**: 내용의 요약이나 축약은 절대 금지됩니다. 소스코드가 가진 모든 정보를 활용하여 원문과 동일하거나 그 이상의 깊이와 세부 정보를 가진 방대한 분량의 텍스트를 작성하십시오. (최소 2,000자 이상, 마크다운 형식)
